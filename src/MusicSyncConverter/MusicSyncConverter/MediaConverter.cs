...
namespace MusicSyncConverter
{
    ...
    {
        public async Task<byte[]> Convert(string sourcePath, EncoderInfo encoderInfo, IReadOnlyDictionary<string, string> tags, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                cancellationToken.ThrowIfCancellationRequested();
                return await File.ReadAllBytesAsync(outFilePath, cancellationToken);
            }
            finally
            {
